...
Component.register('moorl-fence-configurator-list', {
    template,
    ...
    data() {
        return {
            ...
            isLoading: true,
            storeKey: 'grid.filter.moorl_fc',
            activeFilterNumber: 0,
            searchConfigEntity: 'moorl_fc',
        };
    },
            ...
            return [
                {
                    property: 'active',
                    dataIndex: 'active',
                    label: this.$tc('moorl-fence-configurator.properties.active'),
                    inlineEdit: 'boolean',
                    align: 'center'
                },
                {
                    property: 'name',
                    dataIndex: 'name',
                    label: this.$tc('moorl-fence-configurator.properties.name'),
                    routerLink: 'moorl.fence.configurator.detail',
                    inlineEdit: 'string',
                    allowResize: true,
                }
            ]
