...
class Migration1762280635MoorlPlFilter extends MigrationStep
{
    public const OPERATION_HASH = '96885bfb57ad2099236bcb540d56eb6d';
    ...
    {
        $sql = <<<SQL
CREATE TABLE moorl_pl_filter (id BINARY(16) NOT NULL, moorl_pl_id BINARY(16) NOT NULL, version_id BINARY(16) DEFAULT 0x0FA91CE3E96A4BC2BE4BD9CE752C3425 NOT NULL, moorl_pl_version_id BINARY(16) DEFAULT 0x0FA91CE3E96A4BC2BE4BD9CE752C3425 NOT NULL, fixed TINYINT(1) DEFAULT 0, logical TINYINT(1) DEFAULT 0, position INT DEFAULT 0, technical_name VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY (id, version_id, moorl_pl_version_id)) DEFAULT CHARACTER SET utf8mb4;
