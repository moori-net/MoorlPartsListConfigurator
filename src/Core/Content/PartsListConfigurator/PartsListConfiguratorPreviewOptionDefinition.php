...
class PartsListConfiguratorPreviewOptionDefinition extends MappingEntityDefinition
{
    final public const ENTITY_NAME = 'moorl_pl_preview_option';
    final public const EXTENSION_COLLECTION_NAME = 'moorlPlPreviewOptions';
