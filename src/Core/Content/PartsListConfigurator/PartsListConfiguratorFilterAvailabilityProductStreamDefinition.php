...
class PartsListConfiguratorFilterAvailabilityProductStreamDefinition extends MappingEntityDefinition
{
    final public const ENTITY_NAME = 'moorl_pl_filter_availability_ps';
    final public const PROPERTY_NAME = 'availabilityProductStream';
